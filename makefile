...
SRC = main.c token_file1.c token_file2.c token_utils.c syntax_checker.c builtin_echo.c builtin_cd.c builtin_pwd.c  builtin_env.c expander1.c  \
		...
		alloc_envp.c fetch_path.c free_envp.c process_commands.c syntax_checker2.c token_file1_norm.c \
		alloc_envp.c fetch_path.c free_envp.c process_commands.c big_malloc.c  free_cmds_all.c  syntax_checker2.c
